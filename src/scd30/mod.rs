    ...
    T: Instance,
{
    ...
    pub fn get_firmware_version(&mut self) -> Result<[u8; 2], Error> {
        //This is the command we write to the sensor for getting the firmware version,
        //The command is made up of 2 bytes
        //0xd1 is the command for reading the firmware version
